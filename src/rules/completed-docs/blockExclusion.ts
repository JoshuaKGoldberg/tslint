...
export class BlockExclusion implements IExclusion {
    public readonly visibilities: Set<Visibility>;

    public constructor(descriptor: IBlockExclusionDescriptor) {
        this.visibilities = createValuesSet(descriptor.visibilities);
    }
