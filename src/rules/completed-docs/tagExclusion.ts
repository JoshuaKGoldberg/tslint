...
export class TagExclusion implements IExclusion {
    private readonly contentTags: { [i: string]: string };
    private readonly existenceTags: Set<string>;

    public constructor(descriptor: Partial<ITagExclusionDescriptor>) {
        this.contentTags = descriptor.tags ? descriptor.tags.content : {};
        this.existenceTags = new Set(descriptor.tags && descriptor.tags.existence);
    }
